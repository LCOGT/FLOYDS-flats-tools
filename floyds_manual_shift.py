...
ax1.scatter(np.arange(0, len(x_shift_arr), 1)[np.where([np.isclose(xshift[im_num], x, atol=0.04) for x in x_shift_arr])[0][0]], np.arange(0, len(y_shift_arr), 1)[np.where([np.isclose(yshift[im_num], y, atol=0.04) for y in y_shift_arr])[0][0]], c='red', s=10)
...
ax2.scatter(np.arange(0, len(x_shift_arr), 1)[np.where([np.isclose(xshift[im_num], x, atol=0.04) for x in x_shift_arr])[0][0]], np.arange(0, len(y_shift_arr), 1)[np.where([np.isclose(yshift[im_num], y, atol=0.04) for y in y_shift_arr])[0][0]], c='red', s=10)
